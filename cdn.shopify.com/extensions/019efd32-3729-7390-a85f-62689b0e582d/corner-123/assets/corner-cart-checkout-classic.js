 ...
 * @type {Promise<void>}
 */
const whenCornerCartClassicReadyPromise =
...
whenCornerCartClassicReadyPromise.then(() => {
  /**
  ...
  window.CornerWebComponentsAPI.createVariantComponent(
    ...
    'CornerCartCheckoutClassic',
    'CornerCartCheckout',
    BaseClass => {
      return class CornerCartCheckoutClassic extends BaseClass {
        /**
        ...
        /**
         * Creates a cart checkout classic instance and assigns a unique container id.
         *
        ...
        constructor(...args) {
           ...
           * @private
           */
          this._containerId = `corner-cart-checkout-classic-${++CornerCartCheckoutClassic.instanceCounter}`;
        }
                            ...
                            <div id="corner-cowi-cart-cta-wrapper">
                                <button
                                  ...
                                  class=${this.classMap({
                                    ...
                                    'transition-all': true,
                                    'text-lg': true,
                                    'opacity-50': this.checkoutClickedDuringLoading,
                                  })}
